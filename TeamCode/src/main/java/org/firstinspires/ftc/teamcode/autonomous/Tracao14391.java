...
@Config
@Autonomous(name = "Tracao14391", group = "Autonomous")
public class Tracao14391 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // actions that need to happen on init; for instance, a claw tightening.Actions.runBlocking(claw.closeClaw());
